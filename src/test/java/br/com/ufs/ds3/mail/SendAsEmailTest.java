...
public class SendAsEmailTest {
    ...
    public static void setUpBeforeClass() {
        ...
        JabRefPreferences.getInstance().putBoolean(JabRefPreferences.OPEN_FOLDERS_OF_ATTACHED_FILES, false);
    }
    ...
    @Test
    public void generateCorrectUriMailTo() {
    ...
    @Test
    public void generateCorrectUriMailToWithFileLink() {
        JabRefFrame frame = Mockito.mock(JabRefFrame.class);
        BasePanel basePanel = Mockito.mock(BasePanel.class);
        MetaData metaData = Mockito.mock(MetaData.class);
        Mockito.when(frame.getCurrentBasePanel()).thenReturn(basePanel);
    ...
    public void panelNull() {
        JabRefFrame frame = Mockito.mock(JabRefFrame.class);
        Mockito.when(frame.getCurrentBasePanel()).thenReturn(null);
        SendAsEMailAction sendAsEMailAction = new SendAsEMailAction(frame);
        Assert.assertNull(sendAsEMailAction.generateUriMailTo());
    }
    ...
    public void noEntriesSelected() {
        ...
        BibEntry[] selectedEntries = new BibEntry[0];
